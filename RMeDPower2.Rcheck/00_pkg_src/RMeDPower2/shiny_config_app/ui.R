              ...
              fluidRow(
                ...
                column(6,
                  ...
                  fluidRow(
                    ...
                    column(2,
                      br(),
                      actionButton("reset_covariate", 
                                 "Reset",
                                 class = "btn-outline-secondary btn-sm",
                                 style = "margin-top: 25px; width: 100%;",
                                 title = "Reset covariate to None")
                    )
                  ),
                    ...
                    column(10,
                      selectInput("total_column",
                                label = div("Total Column",
                                          style = "font-weight: bold;",
                                          br(),
                                          span("For binomial/poisson/negative_binomial data: denominator column (optional)", style = "font-size: 12px; color: gray;")),
                                choices = NULL,
                                selected = "None")
                    ),
                    column(2,
                      br(),
                      actionButton("reset_total_column", 
                                 "Reset",
                                 class = "btn-outline-secondary btn-sm",
                                 style = "margin-top: 25px; width: 100%;",
                                 title = "Reset total column to None")
                    )
                  ),
