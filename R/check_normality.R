...
check_normality<-function(data, condition_column, experimental_columns, response_column,  condition_is_categorical, covariate = NA,
  ...
  #   return(lmerFit_s$residuals)
    ...
    mres <- get_model_and_data(data,
                               condition_column = condition_column,
                               experimental_columns = experimental_columns,
                               response_column = response_column,
                               condition_is_categorical = condition_is_categorical,
                               covariate = covariate,
    ...
    qqnorm(mres[[4]], ylab="Standardized Residuals", xlab="Normal Scores", main=image_title)
    qqline(mres[[4]])
