...
```{r}
template_dir <- system.file("input_templates/single_cell_data/celltype_proportions_with_genotype", package = "RMeDPower2")
...
template_dir <- system.file("input_templates/single_cell_data/celltype_proportions_with_hippocampus_vol", package = "RMeDPower2")
...
```{r}
template_dir <- system.file("input_templates/single_cell_data/gene_expression_with_genotype", package = "RMeDPower2")
